...
public class DealerSearchUI extends JFrame{
	...
	private JLabel searchBasedOn, dealerID, zipcode, location,  noDealerName;
	...
	private void createComponents() {
 		...
 		noDealerName = new JLabel("Invalid DealerName");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(locationCB.getSelectedItem()!= null) {
				...
				dealers = md.getDealerByLocation(location,0);
					...
					new ui.SearchDealer.ListOfDealersUI(dealers);
